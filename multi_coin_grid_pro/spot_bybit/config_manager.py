"""
Configuration manager for Bybit SPOT grid strategy.
...
class SpotGridBybitConfigManager(BaseConfigManager):
    """
    Config manager for Bybit SPOT grid.
    Inherits from base ConfigManager with Bybit-specific paths.
    """

    def __init__(self):
        super().__init__()
        # Override config directory for Bybit spot
        self.config_dir = Path(__file__).parent / "config"
        self.config_dir.mkdir(parents=True, exist_ok=True)

    def get_default_config_name(self) -> str:
        """Default config name for Bybit spot"""
        return "spot_grid_bybit"

    def get_config_path(self, config_name: str = "spot_grid_bybit", environment: Optional[str] = None) -> Path:
        """
    ...
    def load_config(self, config_name: str = "spot_grid_bybit", environment: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def save_config(self, config: Dict[str, Any], config_name: str = "spot_grid_bybit",
