...
because the bot never accumulates that many. Setting to 0 ensures
every closed executor is written to DB within one tick — crash-safe.
"""
import sys
...
class TestClosedExecutorsBuffer:
    ...
    def test_eur_strategy_buffer(self):
        ...
        assert MultiCoinGridStrategyV2.closed_executors_buffer == 0
    ...
    def test_usd_strategy_buffer(self):
        ...
        assert MultiCoinGridStrategyV2USD.closed_executors_buffer == 0
